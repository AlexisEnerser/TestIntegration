...
import 'side_menu_hamburger_mode.dart';
import 'side_menu_item.dart';
import 'side_menu_style.dart';
import 'side_menu_toggle.dart';
import 'side_menu_item_with_global.dart';
import 'side_menu_expansion_item.dart';
import 'side_menu_expansion_item_with_global.dart';
...
class SideMenuState extends State<SideMenu> {
  ...
  void toggleMenu() {
    if (context
            .findAncestorStateOfType<SideMenuState>()
            ?.animationInProgress ??
        false) {
      return;
    }
