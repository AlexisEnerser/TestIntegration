...
class NoAssignedReports extends StatefulWidget {
  GroupsReportsLogic logic;
  double height;
  double width;
  NoAssignedReports({
    super.key,
  ...
  @override
  State<NoAssignedReports> createState() => NoAssignedReportsState();
}

class NoAssignedReportsState extends State<NoAssignedReports> {
  ...
  Widget build(BuildContext context) {
    return DefaultLayout2(
      ...
      child: Column(
        ...
        children: [
          const Text("Reportes NO asignados", style: layoutTitle,),
                  ...
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return Scrollbar(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (_,index){
                          ReportResponseData item = widget.logic.assignedNoReportsData[index];
                          return SizedBox(
                            width: widget.width,
